...
jQuery(function($) {
    ...
    if (typeof tinyMCE != 'undefined') {
        ...
        tinyMCE.init({
            ...
            theme_advanced_buttons1: "example,|,bold,italic,|,link,unlink,|,image,|,media,charmap,|,code,|,table,|,bullist,numlist,blockquote,|,undo,redo,|,formatselect,|,search,replace,|,fullscreen,|",
