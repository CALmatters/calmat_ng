# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-09-19 20:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='facebook_image',
            field=models.ForeignKey(blank=True, help_text='Image size should be 600 x 315 for best results (or 1200 x 630 for high resolution)', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='voterguides_with_facebook_image', to='media_manager.MediaItem'),
        ),
        migrations.AddField(
            model_name='voterguide',
